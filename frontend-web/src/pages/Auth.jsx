      ...
      >
        ...
        <div className="mt-10">
          <div className="relative flex items-center justify-center mb-8">
            ...
            <span className="relative bg-white px-6 text-[10px] font-black text-gray-300 uppercase tracking-widest">Ya da şununla devam et</span>
          </div>

          <div className="flex gap-4">
             <button className="flex-1 py-4 bg-white border border-gray-100 rounded-2xl flex items-center justify-center gap-3 hover:bg-gray-50 transition-all shadow-sm">
                ...
                <span className="text-[11px] font-black text-[#11142D] uppercase tracking-widest">Google</span>
             </button>
             <button className="flex-1 py-4 bg-[#11142D] rounded-2xl flex items-center justify-center gap-3 hover:bg-black transition-all shadow-sm">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="white"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.341-3.369-1.341-.454-1.152-1.11-1.459-1.11-1.459-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.564 9.564 0 0 1 12 6.844c.85.004 1.705.115 2.504.337 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482C19.138 20.161 22 16.416 22 12c0-5.523-4.477-10-10-10z"/></svg>
                <span className="text-[11px] font-black text-white uppercase tracking-widest">GitHub</span>
             </button>
          </div>
        </div>
